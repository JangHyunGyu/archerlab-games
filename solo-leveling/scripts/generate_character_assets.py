...
def render_frame(actor: Image.Image, cfg: dict, name: str) -> Image.Image:
    ...
    if name.startswith("idle_"):
        ...
        if cfg["effect"] == "light":
            specs = [
                (-10, 1, -14, 1.03, 0.985, 0.03),
                (-3, -4, -7, 0.96, 1.05, 0.28),
                (9, -6, 12, 1.04, 0.98, 0.76),
                (17, -3, 24, 1.10, 0.93, 1.00),
                (11, -1, 8, 1.05, 0.965, 0.64),
                (0, 0, -2, 1.0, 1.0, 0.10),
            ]
        elif cfg["effect"] == "tiger":
            specs = [
                (-9, 4, -10, 1.12, 0.91, 0.03),
                (-3, -7, 8, 0.90, 1.13, 0.34),
                (10, -6, 16, 1.14, 0.88, 0.86),
                (18, 0, 9, 1.22, 0.82, 1.00),
                (9, 3, -8, 1.10, 0.91, 0.58),
                (0, 0, 0, 1.0, 1.0, 0.08),
            ]
        elif cfg["effect"] == "flame":
            specs = [
                (-5, 1, -5, 1.0, 1.02, 0.06),
                (0, -6, 4, 0.96, 1.07, 0.40),
                (5, -9, -8, 1.03, 0.99, 0.86),
                (8, -8, -13, 1.06, 0.96, 1.00),
                (3, -4, 6, 1.02, 1.00, 0.62),
                (0, 0, 0, 1.0, 1.0, 0.10),
            ]
        elif cfg["effect"] == "healer":
            specs = [
                (-4, 2, -7, 1.02, 0.99, 0.05),
                (-6, -10, 11, 0.98, 1.06, 0.30),
                (0, -13, 16, 1.0, 1.03, 0.62),
                (8, 2, -16, 1.08, 0.91, 1.00),
                (4, 2, -5, 1.04, 0.96, 0.68),
                (0, 0, 0, 1.0, 1.0, 0.08),
            ]
        else:
            specs = [
                (-6, 1, -10, 1.03, 0.99, 0.04),
                (-2, -3, -8, 0.97, 1.04, 0.32),
                (8, -5, 10, 1.04, 0.98, 0.82),
                (14, -3, 17, 1.08, 0.94, 1.00),
                (7, -1, 4, 1.03, 0.98, 0.56),
                (0, 0, -1, 1.0, 1.0, 0.08),
            ]
