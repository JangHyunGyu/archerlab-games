...
export const WAVE_CONFIG = {
    baseSpawnInterval: 1150,
    minSpawnInterval: 240,
    spawnReductionPerMinute: 90,
    baseEnemiesPerSpawn: 3,
    extraEnemiesPerMinute: 1.05,
    maxEnemiesOnScreen: 135,
    difficultyMultiplierPerMinute: 0.18,
};
...
export const WEAPONS = {
    ...
    rulersAuthority: {
        ...
        levelBonuses: {
            ...
            7: { damage: 10 },
            8: { range: 45 },
            9: { cooldown: -80, damage: 11 },
            10: { damage: 14, range: 60 },
        },
    },
    dragonFear: {
        name: '용의 공포',
        ...
        slowMultiplier: 0.65,
        auraDuration: 1500,
        effectKey: 'dragon_fear',
        effectOrientation: 'selfRadial',
        levelBonuses: {
            2: { damage: 4 },
            3: { range: 20 },
            4: { slow: 0.01 },
            ...
            7: { slow: 0.02 },
            8: { damage: 6, range: 25 },
            9: { cooldown: -70, slow: 0.02 },
            10: { damage: 8, range: 50, slow: 0.02 },
        },
    },
};
...
Object.assign(WEAPONS, {
    ...
    lightLance: cloneWeapon('shadowDagger', 'lightLance', {
        ...
        effectOrientation: 'projectile',
        effectRotationOffset: -3 * Math.PI / 4,
        combineProceduralVfx: false,
        effectPeakAlpha: 1,
        effectFrameMs: 42,
        effectFadeDelay: 210,
        effectFadeDuration: 180,
        effectColor: 0xffd86a,
        effectGlowColor: 0xffffff,
        effectDarkColor: 0x7a5d16,
        effectScale: 0.52,
    ...
    lightCrescent: cloneWeapon('shadowSlash', 'lightCrescent', {
        ...
        effectOrientation: 'forwardArc',
        effectRotationOffset: -Math.PI / 2,
        effectColor: 0xffd86a,
        effectGlowColor: 0xffffff,
        effectDarkColor: 0x7a5d16,
        effectScale: 0.87,
    ...
    lightJudgment: cloneWeapon('rulersAuthority', 'lightJudgment', {
        ...
        damageMult: 0.56,
        smoothVisual: true,
        visualStartScaleRatio: 0.38,
        visualEndScaleRatio: 1.16,
        visualFadeInDuration: 260,
        visualHoldDuration: 70,
        visualFadeOutDuration: 420,
        visualPeakAlpha: 0.8,
    ...
    lightSanctum: cloneWeapon('dragonFear', 'lightSanctum', {
        ...
        visualFadeOutDuration: 430,
        visualPeakAlpha: 0.72,
    ...
    sanctuaryOrb: cloneWeapon('shadowDagger', 'sanctuaryOrb', {
        ...
        healCooldownMs: 4000,
        levelBonuses: {
            2: { damage: 6, cooldown: -35 },
            3: { damage: 7 },
            4: { damage: 8, cooldown: -35 },
            5: { damage: 8 },
            6: { cooldown: -35 },
            7: { damage: 9 },
            8: { damage: 9 },
            9: { damage: 9, cooldown: -35 },
            10: { damage: 10 },
        },
    ...
    sanctuaryArc: cloneWeapon('shadowSlash', 'sanctuaryArc', {
        ...
        effectOrientation: 'forwardArc',
        effectRotationOffset: Math.PI,
        effectPeakAlpha: 0.96,
        effectHold: 55,
        effectFadeDuration: 360,
        effectColor: 0x66f2b0,
        effectGlowColor: 0xe8fff5,
        effectDarkColor: 0x0d6543,
        effectScale: 0.73,
...
export const PASSIVES = {
    ...
    strength:   { name: '공격력 강화', description: '공격력 +8%', stat: 'attack', bonus: 0.08, icon: 0xff8844 },
    critMaster: { name: '치명타 확률 강화', description: '치명타 확률 +8%', stat: 'critRate', bonus: 0.08, icon: 0xffff44 },
    scholar:    { name: '학습 능력', description: '경험치 +12%', stat: 'xpMultiplier', bonus: 0.12, icon: 0x44aaff },
    hastening:  { name: '쿨타임 감소', description: '스킬 쿨타임 -4.5%', stat: 'cooldownReduction', bonus: 0.045, icon: 0xaa44ff },
