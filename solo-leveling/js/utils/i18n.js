...
const TEXTS = {
    ko: {
        ...
        huntOver: '사냥은 끝났다...',
        continuedRunUnranked: '이어한 기록은 랭킹에 등록되지 않습니다.',
        victory: '던전 클리어!',
        ...
        rankSubmitted: '등록 완료!',
        rankSubmitFailed: '등록에 실패했습니다. 다시 시도해주세요.',
        yourRank: '순위',
        loading: '로딩 중...',
        scoreLabel: '점수',
    },
    ...
    en: {
        ...
        continuedRunUnranked: 'Continued runs are not eligible for ranking.',
        ...
        rankSubmitFailed: 'Submit failed. Try again.',
        yourRank: 'Rank',
        loading: 'Loading...',
        scoreLabel: 'Score',
    },
    ...
    ja: {
        ...
        huntOver: '狩りは終わった...',
        continuedRunUnranked: '続きから再開した記録はランキング対象外です。',
        victory: 'ダンジョンクリア！',
        victoryTitle: 'DUNGEON CLEAR',
        ...
        nameInputTitle: '殿堂入り',
        rankSubmitted: '登録完了！',
        rankSubmitFailed: '登録に失敗しました。もう一度お試しください。',
        yourRank: '順位',
        loading: '読み込み中...',
        scoreLabel: 'スコア',
    },
