...
const COMBAT_EFFECT_KEYS = ['basic_stab', 'flame_burn', 'monster_hit', 'monster_crit', 'monster_death', 'sanctuary_hit'];
...
export const CHARACTER_COMBAT_VFX_ASSET_VERSION = '20260716-shadow-cross-thrust-v7';
