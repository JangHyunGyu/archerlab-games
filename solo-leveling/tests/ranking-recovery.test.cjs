...
assert.match(main, /GameScene\.js\?v=20260913-concept-ui-v4/);
assert.match(main, /GameOverScene\.js\?v=20260904-continuation-rank-v1/);
assert.match(menuScene, /GameScene\.js\?v=20260913-concept-ui-v4/);
assert.match(html, /js\/main\.js\?v=20260913-concept-ui-v4/);
